...
预期验证模型已上架 **OpenClacky**，通过 License 激活使用。
...
> 💡 [在 OpenClacky 安装预期验证模型 →](https://www.openclacky.com/claw/yzwzmx)
>
> 安装后通过 License 激活即可使用全部功能。
...
| 概念 | 解释 |
|------|------|
| **对象a / 对象b** | **对象a** = 你明确意识到的预期（如"我预测会搞砸"）。**对象b** = 你意识不到的隐藏预期，你不认为它是期望，但它在暗中驱动你的情绪反应。对象b是内耗的主要来源。 |
| **核心欲望** | 你真正想要的是什么（预期背后更深层的动机） |
| **心理防御** | 你用来保护自己的借口和理由 |
| **经验烙印** | 过去的经历如何塑造了你今天的预期模式 |
| **情绪溯源** | 每次情绪升起，反推背后的预期——越练越准 |
| **机会成本** | 你为这个情绪付出了什么？每分每秒的情绪都在产生真实损失——时间、金钱、关系、行动机会。看清代价，"值不值得"就有了答案 |
